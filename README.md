...
<br>Figure 1. Comparison to existing methods on speed-accuracy tradeoff, tested on WFLW full test set (closer to bottom-right corner is better).<br><br>

<img src="images/detection_heads.png" alt="det_heads" width="512px"/>
<br>Figure 2. Comparison of different detection heads.<br>
