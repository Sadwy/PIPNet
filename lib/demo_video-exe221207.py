...
contour_mapping = 0  # tag: 映射mapping
schema_mask = 1.1  # tag: 曲线轮廓bezier curve
depthable_mask = 1  # mask大小随深度改变而改变
# ==/Switch==
...
def co_x_y(case):
    ...
    # elif case == '70l' or case == '70':
    #     # 70_left
    #     co_x = [-4361.535660274178, 524.2318960523315]#第二次20个数据#[-4502.48375702, 907.93902028]
    #     co_y = [147.78138671304507, 4250.709178452929, 1527.065933586975]#第二次20个数据#[-325.41544726, 4885.63019524, 616.19006291]
    # elif case == '70r':
    #     # 70_right
    #     co_x = [-4260.3034235, 1202.64091932]
    #     co_y = [-2013.47849918, 5683.19348496, 3133.07744805]
    # elif case == '80l' or case == '80':
    #     # 80_left
    #     co_x = [-6548.32344444, 1189.28551441]
    #     co_y = [ 301.57319077, 4763.78902417, -43.02815817]
    # elif case == '80r':
    #     # 80_right
    #     co_x = [-4897.63273649, 1107.31067917]
    #     co_y = [-638.83496485, 4716.15366189, 1018.34471107]
    # elif case == '90l' or case == '90':
    #     # 90_left
    #     co_x = [-3978.49026381, 965.56658766]
    #     co_y = [ 117.7815418 , 4563.38901768, 168.19236075]
    # elif case == '90r':
    #     # 90_right
    #     co_x = [-4502.14740842, 1155.74946041]
    #     co_y = [-1398.92957404, 5284.64159915, 1767.3287281]
    # elif case == '100l' or case == '100':
    #     # 100_left
    #     co_x = [-4618.21446938, 1018.32283029]
    #     co_y = [ -88.0481891 , 4818.7775955 , 451.59586686]
    # elif case == '100r':
    #     # 100_right
    #     co_x = [-4656.80144443, 1186.54766]
    #     co_y = [-212.52631105, 4788.12762774, 532.07334448]
    else:
        sys.exit("The case not stored!")
    return co_x, co_y

# co_x, co_y = co_x_y('50l')
# print(co_y.shape)
...
# 2. 分析point的z轴数据，平滑显示 DONE
                ...
                def fun_co(dep):
                    ...
                    dep = int(dep*10)/10.
                    if dep <= 0.3:
                        co_x, co_y = co_x_y('30l')
                    elif dep == 0.4:
                        co_x, co_y = co_x_y('40l')
                    elif dep == 0.5:
                        co_x, co_y = co_x_y('50l')
                    # elif dep == 0.6:
                    #     co_x, co_y = co_x_y('80')
                ...
                def Mi_coor(Ca_coor, co_x, co_y):
                    ...
                    return Mi_x, Mi_y
                def Mi_coor_smooth(Ca_coor, dep):
                    """
                ...
                if init_Mi_coor==0:
                    if depthable_mask == 1:
                        temp_x, temp_y = Mi_coor_smooth(Ca_coor, depth_base)
